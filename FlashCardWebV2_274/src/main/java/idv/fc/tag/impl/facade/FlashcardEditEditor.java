...
public class FlashcardEditEditor extends Editor<Flashcard> {

	public FlashcardEditEditor(Flashcard data) {
		super(data);
	}
	...
	protected void createDefinition(StringBuffer buffer) {
		...
		StringBuffer bufBody = new StringBuffer();
		{
			...
			cmptDiv.addHtmlClass("col-lg-10");
			{
				...
				cmptInput.addAttribute("value", this.getData().getDefinition());
